...
import 'package:idle_notifier/form.dart';
...
void main() {
  runApp(const IdleNotifier());
}

class IdleNotifier extends StatelessWidget {
  const IdleNotifier({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
        ...
        home: const MyHomePage(title: 'Idle Notifier'));
  }
}
